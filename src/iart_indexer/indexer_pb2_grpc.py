...
class IndexerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.analyze = channel.unary_unary(
                '/iart.indexer.Indexer/analyze',
                request_serializer=indexer__pb2.AnalyzeRequest.SerializeToString,
                response_deserializer=indexer__pb2.AnalyzeReply.FromString,
                )
...
def add_IndexerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'analyze': grpc.unary_unary_rpc_method_handler(
                    servicer.analyze,
                    request_deserializer=indexer__pb2.AnalyzeRequest.FromString,
                    response_serializer=indexer__pb2.AnalyzeReply.SerializeToString,
            ),
...
class Indexer(object):
    ...
    def analyze(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/iart.indexer.Indexer/analyze',
            indexer__pb2.AnalyzeRequest.SerializeToString,
            indexer__pb2.AnalyzeReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def delete(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/iart.indexer.Indexer/delete',
    ...
    def collection_delete(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/iart.indexer.Indexer/collection_delete',
    ...
    def collection_list(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/iart.indexer.Indexer/collection_list',
