...
class IndexerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.analyse = channel.unary_unary(
                ...
                request_serializer=indexer__pb2.AnalyseRequest.SerializeToString,
                response_deserializer=indexer__pb2.AnalyseReply.FromString,
                )
...
def add_IndexerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'analyse': grpc.unary_unary_rpc_method_handler(
                    servicer.analyse,
                    request_deserializer=indexer__pb2.AnalyseRequest.FromString,
                    response_serializer=indexer__pb2.AnalyseReply.SerializeToString,
            ),
...
class Indexer(object):
    ...
    def analyse(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/iart.indexer.Indexer/analyse',
            indexer__pb2.AnalyseRequest.SerializeToString,
            indexer__pb2.AnalyseReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
